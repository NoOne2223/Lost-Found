document.addEventListener("DOMContentLoaded", () => {
  ...
  langSwitch.addEventListener("click", (e) => {
    ...
    if (langSwitch.textContent.trim() === "AR") {
      ...
      // Navbar
      document.querySelector(".navbar-brand").innerHTML = '<i class="fa-solid fa-box-open me-2"></i> نظام المفقودات';
      ...
      // Navbar
      document.querySelector(".navbar-brand").innerHTML = '<i class="fa-solid fa-box-open me-2"></i> Lost & Found System';
      document.querySelectorAll(".nav-link").forEach(link => {
